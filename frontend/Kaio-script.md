...
- Data model gồm các field: id, name, isEnable (default true), status, score, startTime, endTime, teamId, stationId.
...
- Form: id (edit mode only), name, isEnable (default true).
